...
- [AI INDEX](C:/HB TRACK/docs/_ai/_INDEX.md)
- [AGENT PROTOCOL](C:/HB TRACK/docs/_ai/INVARIANTS_AGENT_PROTOCOL.md)
- [AGENT GUARDRAILS](C:/HB TRACK/docs/_ai/INVARIANTS_AGENT_GUARDRAILS.md)
- SSOT catálogo: [INVARIANTS_TRAINING](C:/HB TRACK/docs/02_modulos/training/INVARIANTS/INVARIANTS_TRAINING.md)
- Testes canônicos: [INVARIANTS_TESTING_CANON](C:/HB TRACK/docs/02_modulos/training/INVARIANTS/INVARIANTS_TESTING_CANON.md)
- Backlog/candidates: [candidates](C:/HB TRACK/docs/02_modulos/training/INVARIANTS/training_invariants_candidates.md) e [backlog](C:/HB TRACK/docs/02_modulos/training/INVARIANTS/training_invariants_backlog.md)

## Evidência/Artefatos

- verificador: [verify_invariants_tests.py](C:/HB TRACK/docs/scripts/verify_invariants_tests.py)
