...
Para qualquer tarefa no módulo ATLETAS, a cadeia canônica obrigatória é:
...
Regra:
- Em caso de conflito, `00_ATLETAS_CROSS_LINTER_RULES.json` + `15_ATLETAS_INVARIANTS.yaml` prevalecem sobre quaisquer outros documentos do módulo.
- `ANALISE_CONTRATOS_GAPS.md` não é SSOT ativo — é evidência histórica de análise, não autoriza modificação de comportamento.
