...
revision: str = '41e6ff9bc859'
down_revision: Union[str, Sequence[str], None] = '314e57818480'
...
def upgrade() -> None:
    ...
    op.execute("""
        CREATE INDEX IF NOT EXISTS ix_athletes_organization_id 
...
def downgrade() -> None:
    ...
    op.execute("DROP INDEX IF EXISTS ix_athletes_organization_id")
