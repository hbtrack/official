...
## Resumo rápido
- **Produto:** HB Track — plataforma esportiva para handebol
...
Claude opera por paridade operacional — não existe mecanismo equivalente a `.github/agents/*.agent.md` para Claude. Papéis: `HB Contract`, `Hb Implementer`, `Hb Adversarial Tester`, `Hb Merger`. Como tester externo final (não é autoridade final), usa apenas **pacote estruturado de evidências**, sem narrativa do implementador. Conclusão condicionada a gates executáveis.
