"""
OffensivePosition model - lookup for offensive positions.
...
class OffensivePosition(Base):
    __tablename__ = "offensive_positions"


# HB-AUTOGEN:BEGIN
    # AUTO-GENERATED FROM DB (SSOT). DO NOT EDIT MANUALLY.
    # Table: public.offensive_positions
    __table_args__ = (
        UniqueConstraint('code', name='ux_offensive_positions_code'),
    )

    id: Mapped[int] = mapped_column(sa.Integer(), primary_key=True, server_default=sa.text('nextval(\'"public".offensive_positions_id_seq\'::regclass)'))
    ...
    def __repr__(self) -> str:
        return f"<OffensivePosition(id={self.id}, code='{self.code}')>"
