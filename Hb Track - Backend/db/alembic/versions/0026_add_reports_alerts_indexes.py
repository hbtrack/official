...
def upgrade() -> None:
    ...
    # ===========================================================================
    # MATCH_ROSTER (Presença em jogos)
    # Queries: filter by athlete_id, match_id + join matches for team/date
    # ===========================================================================
    
    # Índice composto para relatórios por atleta em jogos
    op.execute("""
        CREATE INDEX IF NOT EXISTS ix_match_roster_athlete_match
        ON match_roster (athlete_id, match_id);
    """)
...
def downgrade() -> None:
    ...
    op.execute("DROP INDEX IF EXISTS ix_match_roster_athlete_match;")
