-- Schema dump generated: 2026-03-03T04:26:48.573576+00:00Z
-- Source: localhost
...
\restrict 0MzE1ejn7YhMVm9Gxi2h1bLk2Ke3eicgLQFXz2ZXeFVd2bhnRZWGkuGZtVw8RW5
...
--
-- Name: fn_sync_birth_date_athletes_to_persons(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fn_sync_birth_date_athletes_to_persons() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
        BEGIN
...
--
-- Name: fn_validate_birth_date_parity_on_person(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fn_validate_birth_date_parity_on_person() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
        DECLARE
...
CREATE TABLE public.competition_opponent_teams (
    ...
    deleted_at timestamp with time zone,
    deleted_reason text,
    CONSTRAINT ck_competition_opponent_teams_deleted_reason CHECK ((((deleted_at IS NULL) AND (deleted_reason IS NULL)) OR ((deleted_at IS NOT NULL) AND (deleted_reason IS NOT NULL))))
);
...
CREATE TABLE public.competition_phases (
    ...
    deleted_at timestamp with time zone,
    deleted_reason text,
    CONSTRAINT ck_competition_phases_deleted_reason CHECK ((((deleted_at IS NULL) AND (deleted_reason IS NULL)) OR ((deleted_at IS NOT NULL) AND (deleted_reason IS NOT NULL))))
);
...
CREATE TABLE public.match_events (
    ...
    deleted_at timestamp with time zone,
    deleted_reason text,
    CONSTRAINT ck_match_events_deleted_reason CHECK ((((deleted_at IS NULL) AND (deleted_reason IS NULL)) OR ((deleted_at IS NOT NULL) AND (deleted_reason IS NOT NULL)))),
...
CREATE TABLE public.match_roster (
    ...
    deleted_at timestamp with time zone,
    deleted_reason text,
    CONSTRAINT ck_match_roster_deleted_reason CHECK ((((deleted_at IS NULL) AND (deleted_reason IS NULL)) OR ((deleted_at IS NOT NULL) AND (deleted_reason IS NOT NULL)))),
...
--
-- Name: ix_competition_standings_team_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_competition_standings_team_id ON public.competition_standings USING btree (team_id);
...
--
-- Name: competition_matches trg_competition_matches_block_delete; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_competition_matches_block_delete BEFORE DELETE ON public.competition_matches FOR EACH ROW EXECUTE FUNCTION public.trg_block_physical_delete();


--
-- Name: competition_opponent_teams trg_competition_opponent_teams_block_delete; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_competition_opponent_teams_block_delete BEFORE DELETE ON public.competition_opponent_teams FOR EACH ROW EXECUTE FUNCTION public.trg_block_physical_delete();


--
-- Name: competition_phases trg_competition_phases_block_delete; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_competition_phases_block_delete BEFORE DELETE ON public.competition_phases FOR EACH ROW EXECUTE FUNCTION public.trg_block_physical_delete();
...
--
-- Name: match_events trg_match_events_block_delete; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_match_events_block_delete BEFORE DELETE ON public.match_events FOR EACH ROW EXECUTE FUNCTION public.trg_block_physical_delete();


--
-- Name: match_roster trg_match_roster_block_delete; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_match_roster_block_delete BEFORE DELETE ON public.match_roster FOR EACH ROW EXECUTE FUNCTION public.trg_block_physical_delete();
...
--
-- Name: athletes trg_sync_birth_date_athletes; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_sync_birth_date_athletes AFTER UPDATE OF birth_date ON public.athletes FOR EACH ROW EXECUTE FUNCTION public.fn_sync_birth_date_athletes_to_persons();
...
--
-- Name: persons trg_validate_birth_date_persons; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_validate_birth_date_persons BEFORE UPDATE OF birth_date ON public.persons FOR EACH ROW EXECUTE FUNCTION public.fn_validate_birth_date_parity_on_person();
...
--
-- Name: competition_standings fk_competition_standings_team_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.competition_standings
    ADD CONSTRAINT fk_competition_standings_team_id FOREIGN KEY (team_id) REFERENCES public.teams(id) ON DELETE SET NULL;
...
\unrestrict 0MzE1ejn7YhMVm9Gxi2h1bLk2Ke3eicgLQFXz2ZXeFVd2bhnRZWGkuGZtVw8RW5
