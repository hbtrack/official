...
class _Session:
    ...
    def __init__(self, status: str, session_at: datetime, ended_at: datetime = None):
        self.status = status
...
class TestInvTrain004EditWindowTime:
    ...
    def _create_mock_session(
        ...
        """Cria objeto de sessão com status, session_at e ended_at especificados."""
        return _Session(status=status, session_at=session_at, ended_at=ended_at)
