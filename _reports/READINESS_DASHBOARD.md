...
> Gerado em 2026-05-05T23:44:49Z | run_id: `20260505T234449_fba142` | health: **100/100** | overall: **DEGRADED**
...
| API_NORMATIVE_DUPLICATION_GATE | PASS | sim |
...
| DECISION_MATERIALIZATION_GATE | DEGRADED | sim |
...
| FRONTEND_CONTRACT_GATE | PASS | sim |
| DERIVED_DRIFT_GATE | PASS | sim |
| ADVERSARIAL_ANALYSIS_GATE | PASS | sim |
| FEATURE_READINESS_GATE | PASS | sim |
| VERSIONING_POLICY_GATE | PASS | sim |
| PACT_PROVIDER_GATE | SKIP_NOT_APPLICABLE | sim |
| CODE_ARCHITECTURE_GATE | PASS | sim |
| DEPLOY_READINESS_GATE | PASS | sim |
| DATA_MIGRATION_GATE | PASS | sim |
| MONITORING_POLICY_GATE | PASS | sim |
| ARCHITECTURE_FACTUALITY_GATE | PASS | sim |
| HOOK_EFFECTIVENESS_GATE | PASS | sim |
| LIVE_ENFORCEMENT_PARITY_GATE | PASS | sim |
| HANDOFF_COHERENCE_GATE | PASS | sim |
| MODULE_STATUS_COHERENCE_GATE | PASS | sim |
| SURFACE_PROMOTION_COHERENCE_GATE | PASS | sim |
| MODULE_BEHAVIORAL_READINESS_GATE | PASS | sim |
| CROSS_MODULE_BOUNDARY_GATE | PASS | sim |
...
| GOVERNANCE_REGRESSION_GATE | PASS | sim |
| DOMAIN_GLOSSARY_CONSISTENCY_GATE | PASS | sim |
...
| IMPLEMENTATION_SCOPE_FIREWALL_GATE | SKIP_NOT_APPLICABLE | sim |
| PLAN_DIFF_TRACE_GATE | SKIP_NOT_APPLICABLE | sim |
| NEGATIVE_TEST_COVERAGE_GATE | SKIP_NOT_APPLICABLE | sim |
| POST_PR_ADVERSARIAL_GATE | SKIP_NOT_APPLICABLE | sim |
| IMPLEMENTATION_STATE_GATE | SKIP_NOT_APPLICABLE | sim |
| EVIDENCE_PACK_COMPLETENESS_GATE | SKIP_NOT_APPLICABLE | sim |
| REPORT_TRUTHFULNESS_GATE | PASS | sim |
| READINESS_SUMMARY_GATE | DEGRADED | nao |
