...
description: >
  ...
  HB Track. Receives only objective, acceptance criteria, diff, logs and
  evidence_pack. Does not trust implementer conclusions. Reports
  ADVERSARIAL_PASS_PENDING_GATE, ADVERSARIAL_FAIL, or INCONCLUSIVE.
...
Você é testador adversarial com contexto isolado.
...
Usar schema: `.dev/schemas/hb_gate_report.schema.json`
