...
description: >
  ...
  Reports GOVERNANCE_PASS_PENDING_GATE, GOVERNANCE_FAIL, or INCONCLUSIVE.
...
.github/ai-review/styleguide.md     ← Gemini AI Review (verificar consistência)
CLAUDE.md
.codex
.codex/agents/*.toml
.claude/agents/*.md
...
- Bridge docs NÃO podem contradizer `docs/_canon/AI_EXECUTION_ROLES_POLICY.md`.
