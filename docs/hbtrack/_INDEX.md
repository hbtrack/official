...
| AR_004 | MatchEventService.create() — ORM correto, roster, is_shot... | 🏗️ EM_EXECUCAO | docs/hbtrack/evidence/AR_004/executor_main.log |
...
| AR_069 | Fix write_scope Pipeline: Schema + build_ar_content + GAT... | 🏗️ EM_EXECUCAO | docs/hbtrack/evidence/AR_069/executor_main.log |
...
| AR_999 | Exemplo: Adicionar campo birthdate em Person | 🏗️ EM_EXECUCAO | docs/hbtrack/evidence/AR_999/executor_main.log |
