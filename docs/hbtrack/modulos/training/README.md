...
## Objetivo
Documentar o escopo normativo do módulo `training` e suas superfícies soberanas.

## Superfícies soberanas (referências)
- HTTP (OpenAPI paths): `contracts/openapi/paths/training.yaml`
- Schemas de domínio: `contracts/schemas/training/`
- Workflows (Arazzo): `contracts/workflows/training/` (quando aplicável)
