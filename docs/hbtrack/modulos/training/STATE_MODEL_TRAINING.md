...
### Transições explicitamente proibidas (exemplos)

| De | Para | Motivo |
|---|---|---|
| `DRAFT` | `COMPLETED` | Salto de estado inválido |
| `COMPLETED` | `IN_PROGRESS` | Imutabilidade pós-COMPLETED (TRAIN-DEC-013) |
| `ARCHIVED` | qualquer | Estado terminal absoluto |
| `CANCELLED` | qualquer | Estado terminal absoluto |
