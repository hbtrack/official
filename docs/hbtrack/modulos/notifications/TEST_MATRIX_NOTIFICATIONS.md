...
- O conjunto mínimo compilável do módulo está em `docs/hbtrack/modulos/notifications/graph/test_obligations.yaml`.
- O pipeline deve manter `test_obligations.yaml` coerente com `contracts/`, `src/notifications/tests/` e `_reports/contract_gates/latest.json`.
