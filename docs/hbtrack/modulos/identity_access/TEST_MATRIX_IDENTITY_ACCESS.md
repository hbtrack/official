...
- O conjunto mínimo compilável do módulo está em `docs/hbtrack/modulos/identity_access/graph/test_obligations.yaml`.
- O pipeline deve manter `test_obligations.yaml` coerente com `contracts/`, `src/identity_access/tests/` e `_reports/contract_gates/latest.json`.
