...
type: "readme"
module_scope_ref: "./MODULE_SCOPE_MEDICAL.md"
domain_rules_ref: "./DOMAIN_RULES_MEDICAL.md"
invariants_ref: "./INVARIANTS_MEDICAL.md"
test_matrix_ref: "./TEST_MATRIX_MEDICAL.md"
...
## Objetivo
Documentar o escopo normativo do módulo `medical` e suas superfícies soberanas.

## Superfícies soberanas (referências)
- HTTP (OpenAPI paths): `contracts/openapi/paths/medical.yaml`
- Schemas de domínio: `contracts/schemas/medical/`
...
- Entidades: `docs/hbtrack/modulos/medical/graph/entities.yaml`
