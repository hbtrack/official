...
## Objetivo
Documentar o escopo normativo do módulo `teams` e suas superfícies soberanas.

## Superfícies soberanas (referências)
- HTTP (OpenAPI paths): `contracts/openapi/paths/teams.yaml`
- Schemas de domínio: `contracts/schemas/teams/`
- Workflows (Arazzo): `contracts/workflows/teams/` (quando aplicável)
