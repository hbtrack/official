...
## Objetivo
Documentar o escopo normativo do módulo `matches` e suas superfícies soberanas.

## Superfícies soberanas (referências)
- HTTP (OpenAPI paths): `contracts/openapi/paths/matches.yaml`
- Schemas de domínio: `contracts/schemas/matches/`
- Workflows (Arazzo): `contracts/workflows/matches/` (quando aplicável)
