...
## Objetivo
Documentar o escopo normativo do módulo `seasons` e suas superfícies soberanas.

## Superfícies soberanas (referências)
- HTTP (OpenAPI paths): `contracts/openapi/paths/seasons.yaml`
- Schemas de domínio: `contracts/schemas/seasons/`
- Workflows (Arazzo): `contracts/workflows/seasons/` (quando aplicável)
