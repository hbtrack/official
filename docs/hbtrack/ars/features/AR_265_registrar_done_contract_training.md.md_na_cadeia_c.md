# AR_265 — Registrar DONE_CONTRACT_TRAINING.md.md na cadeia canônica

**Status**: ✅ SUCESSO
**Versão do Protocolo**: 1.3.0

## Descrição
Atualizar docs/hbtrack/modulos/treinos/_INDEX.md para incluir DONE_CONTRACT_TRAINING.md.md como documento normativo complementar de autoridade na cadeia TRAINING.

Este é um AR de governança pura (classe G). O arquivo DONE_CONTRACT_TRAINING.md.md já existe em docs/hbtrack/modulos/treinos/. O Executor deve:

1. Abrir docs/hbtrack/modulos/treinos/_INDEX.md.
2. Na seção 'Mapa de Autoridade' / 'Cadeia normativa do módulo TRAINING', adicionar uma entrada para 'DONE_CONTRACT_TRAINING.md.md' após TEST_MATRIX_TRAINING.md (posição 6) e antes de AR_BACKLOG_TRAINING.md. O texto deve indicar que este documento define os critérios de encerramento (DONE_TECNICO, DONE_SEMANTICO, DONE_PRODUTO) e é autoridade normativa sobre declarações de conclusão do módulo.
...
## Critérios de Aceite
1) docs/hbtrack/modulos/treinos/_INDEX.md contém a string 'DONE_CONTRACT_TRAINING.md.md'. 2) Changelog do _INDEX.md menciona 'Batch 35'. 3) A referência ao DONE_CONTRACT aparece próxima a TEST_MATRIX no Mapa de Autoridade. 4) O arquivo _INDEX.md é YAML/Markdown válido sem truncamento.
