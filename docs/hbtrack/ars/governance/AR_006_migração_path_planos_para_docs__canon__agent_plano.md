...
```
python scripts/run/hb_cli.py version && python scripts/run/hb_cli.py plan docs/_canon/planos/matchservice.json
```
...
### Execução em b2e7523
**Status Final**: ❌ FALHA
**Comando**: `python scripts/run/hb_cli.py version && python scripts/run/hb_cli.py plan docs/_canon/planos/matchservice.json`
**Exit Code**: 1
**Evidence File**: `docs/hbtrack/evidence/AR_006_gov_plans_path_migration.log`
