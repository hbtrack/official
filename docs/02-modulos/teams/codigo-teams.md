...
<aside class="w-[72px] lg:w-[240px] flex-shrink-0 flex flex-col border-r border-hb-border dark:border-slate-800 bg-hb-surface dark:bg-[#0f0f0f] z-30">
<div class="h-[60px] flex items-center justify-center lg:justify-start lg:px-5 border-b border-hb-border dark:border-slate-800">
<div class="flex items-center gap-3">
<div class="flex h-7 w-7 items-center justify-center bg-slate-900 dark:bg-white text-white dark:text-black font-semibold text-[11px] tracking-tight rounded-sm">
                    H3
                </div>
<span class="font-display font-semibold text-[15px] tracking-tight hidden lg:block text-slate-900 dark:text-white">HB Track</span>
</div>
</div>
<nav class="flex-1 overflow-y-auto py-5 px-3 space-y-1">
<a class="flex items-center gap-3 px-3 py-2 rounded-md text-body font-medium text-hb-muted dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-all group" href="#">
<span class="material-symbols-outlined text-[20px] text-hb-subtle group-hover:text-slate-900 dark:group-hover:text-white transition-colors">grid_view</span>
<span class="hidden lg:block">Dashboard</span>
</a>
<div class="pt-4 pb-1.5 px-3 text-[11px] font-medium text-slate-400 dark:text-slate-600 hidden lg:block tracking-wide">
                Gestão
            </div>
<a class="flex items-center gap-3 px-3 py-2 rounded-md bg-slate-100 dark:bg-slate-900/80 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-800 shadow-sm" href="#">
<span class="material-symbols-outlined text-[20px]">groups</span>
<span class="hidden lg:block text-body font-medium">Equipes</span>
</a>
<a class="flex items-center gap-3 px-3 py-2 rounded-md text-body font-medium text-hb-muted dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-all group" href="#">
<span class="material-symbols-outlined text-[20px] text-hb-subtle group-hover:text-slate-900 dark:group-hover:text-white transition-colors">person</span>
<span class="hidden lg:block">Atletas</span>
</a>
<div class="pt-4 pb-1.5 px-3 text-[11px] font-medium text-slate-400 dark:text-slate-600 hidden lg:block tracking-wide">
                Dados
            </div>
<a class="flex items-center gap-3 px-3 py-2 rounded-md text-body font-medium text-hb-muted dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-all group" href="#">
<span class="material-symbols-outlined text-[20px] text-hb-subtle group-hover:text-slate-900 dark:group-hover:text-white transition-colors">videocam</span>
<span class="hidden lg:block">Live Scout</span>
</a>
<a class="flex items-center gap-3 px-3 py-2 rounded-md text-body font-medium text-hb-muted dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-all group" href="#">
<span class="material-symbols-outlined text-[20px] text-hb-subtle group-hover:text-slate-900 dark:group-hover:text-white transition-colors">analytics</span>
<span class="hidden lg:block">Relatórios</span>
</a>
</nav>
<div class="p-3 border-t border-hb-border dark:border-slate-800">
<button class="flex items-center gap-3 w-full group p-2 rounded-md hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
<div class="h-7 w-7 rounded-sm bg-slate-200 dark:bg-slate-800 flex items-center justify-center text-slate-600 dark:text-slate-400 font-bold text-[10px] border border-slate-300 dark:border-slate-700">
                    NS
                </div>
<div class="flex-1 text-left hidden lg:block overflow-hidden">
<p class="text-[13px] font-medium text-slate-700 dark:text-slate-200 truncate">Nathan Silva</p>
<p class="text-[11px] text-slate-400 truncate">Head Coach</p>
</div>
</button>
</div>
</aside>
