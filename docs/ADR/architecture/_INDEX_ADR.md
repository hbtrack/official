...
As ADRs documentam **decisões técnicas já tomadas**, derivadas exclusivamente das fontes canônicas definidas em `_MAPA_DE_CONTEXTO.md`:
- PRDs
- TRD_TRAINING
- INVARIANTS_TRAINING
- Artefatos `_generated`
...
**Arquivo**: [`001-ADR-TRAIN-ssot-precedencia.md`](docs/ADR/architecture/001-ADR-TRAIN-ssot-precedencia.md)
**Status**: ACCEPTED
**Resumo**:
...
**Arquivo**: [`002-ADR-TRAIN-trd-por-referencia.md`](docs/ADR/architecture/002-ADR-TRAIN-trd-por-referencia.md)
**Status**: ACCEPTED
**Resumo**:
...
**Arquivo**: [`003-ADR-TRAIN-lifecycle-training.md`](docs/ADR/architecture/003-ADR-TRAIN-lifecycle-training.md)
**Status**: ACCEPTED
**Resumo**:
...
**Arquivo**: [`004-ADR-TRAIN-invariantes-como-contrato.md`](docs/ADR/architecture/004-ADR-TRAIN-invariantes-como-contrato.md)
**Status**: ACCEPTED
**Resumo**:
...
**Arquivo**: [`005-ADR-TRAIN-soft-delete.md`](docs/ADR/architecture/005-ADR-TRAIN-soft-delete.md)
**Status**: ACCEPTED
**Resumo**:
...
**Arquivo**: [`006-ADR-TRAIN-timezone-canonico.md`](docs/ADR/architecture/006-ADR-TRAIN-timezone-canonico.md)
**Status**: ACCEPTED
**Resumo**:
...
**Arquivo**: [`007-ADR-TRAIN-celery-async.md`](docs/ADR/architecture/007-ADR-TRAIN-celery-async.md)
**Status**: ACCEPTED
**Resumo**:
...
**Arquivo**: [`008-ADR-TRAIN-governanca-por-artefatos.md`](docs/ADR/architecture/008-ADR-TRAIN-governanca-por-artefatos.md)
**Status**: ACCEPTED
**Resumo**:
...
**Arquivo**: [`009-ADR-TRAIN-focus-percentages.md`](docs/ADR/architecture/009-ADR-TRAIN-focus-percentages.md)
**Status**: ACCEPTED
...
**Arquivo**: [`010-ADR-TRAIN-multi-tenancy.md`](docs/ADR/architecture/010-ADR-TRAIN-multi-tenancy.md)
**Status**: ACCEPTED
**Origem**: Evidence-first (100% derivada de `schema.sql`)
**Resumo**:
...
**Arquivo**: [`011-ADR-TRAIN-rbac-papeis-permissoes.md`](docs/ADR/architecture/011-ADR-TRAIN-rbac-papeis-permissoes.md)
**Status**: ACCEPTED
**Origem**: Evidence-first (100% derivada de `schema.sql`)
**Resumo**:
...
**Arquivo**: [`ADR_TEMPLATE.md`](docs/ADR/architecture/ADR_TEMPLATE.md)
...
- `docs/_MAPA_DE_CONTEXTO.md`
- `docs/PRD_BASELINE_ASIS_TRAINING.md`
- `docs/Hb Track/PRD_HB_TRACK.md`
- `docs/TRD_TRAINING.md`
- `docs/INVARIANTS_TRAINING.md`
- Artefatos `_generated` (`schema.sql`, `openapi.json`, `alembic_state.txt`, `manifest.json`)
