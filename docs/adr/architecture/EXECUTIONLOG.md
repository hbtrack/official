...
| 2026-02-08 22:45 | `T-325` | **FASE 4 - SMOKE TEST 3B**: Guard violation real - drift com baseline válido | ✅ PASS | Exit code 2; marcador adicionado a `exit_codes.md`, guard detectou modificação corretamente. |
...
| 2026-02-08 22:55 | `T-327` | **CORREÇÃO DOCUMENTAL**: Análise de `agent_guard.py` linha 225 | ⚠️ DISCOVERY | Código retorna `exit=2` para violations, NÃO `exit=3` como documentação original especificava. |
