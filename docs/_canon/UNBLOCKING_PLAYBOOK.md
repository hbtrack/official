...
Verificar o path correto em `CLAUDE.md` §8. Pedir para a IA "Mova o arquivo [X] para o path correto."
...
| Regras do sistema de contratos | `CLAUDE.md` |
| Bloqueios e seus significados | `CLAUDE.md` §5 |
