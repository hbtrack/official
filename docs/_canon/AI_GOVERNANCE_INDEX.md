...
- `docs/ADR/002-ADR-TRAIN-trd-por-referencia.md`
- `docs/ADR/003-ADR-TRAIN-lifecycle-training.md`
- `docs/ADR/004-ADR-TRAIN-invariantes-como-contrato.md`
- `docs/ADR/005-ADR-TRAIN-soft-delete.md`
- `docs/ADR/006-ADR-TRAIN-timezone-canonico.md`
- `docs/ADR/007-ADR-TRAIN-celery-async.md`
- `docs/ADR/008-ADR-TRAIN-governanca-por-artefatos.md`
- `docs/ADR/009-ADR-TRAIN-focus-percentages.md`
- `docs/ADR/010-ADR-TRAIN-multi-tenancy.md`
- `docs/ADR/011-ADR-TRAIN-rbac-papeis-permissoes.md`
- `docs/ADR/012-ADR-INV-TRAIN.md`
- `docs/ADR/013-ADR-MODELS.md`
- `docs/ADR/014-ADR-MODELS.md`
- `docs/ADR/015-ADR-INV.md`
- `docs/ADR/016-ADR-machine-readable-ai-quality-gates.md`
- `docs/ADR/017-ADR-DOCS-documentacao-humana.md`
...
- `docs/execution_tasks/EXEC_TASK_ADR_MODELS_001.md`
- `docs/execution_tasks/EXEC_TASK_ADR_MODELS_014.md`
