...
1. **O que governa as decisões neste projeto?**  
   → Leia: [01_AUTHORITY_SSOT.md](01_AUTHORITY_SSOT.md)  
   → Evidência: [001-ADR-TRAIN-ssot-precedencia.md](../ADR/architecture/001-ADR-TRAIN-ssot-precedencia.md)

2. **Quero fazer X, por onde começo?**  
   → Leia: [02_CONTEXT_MAP.md](02_CONTEXT_MAP.md)  
   → Encontre sua intenção e siga o fluxo recomendado

3. **Qual é o passo-a-passo para tarefa Y?**  
   → Leia: [03_WORKFLOWS.md](03_WORKFLOWS.md)  
   → Workflows operacionais com checklists

4. **Quais são as restrições, constraints e invariantes do sistema?**  
   → Leia: [../02-modulos/training/INVARIANTS/INVARIANTS_TRAINING.md](../02-modulos/training/INVARIANTS/INVARIANTS_TRAINING.md)  
   → Evidência: `schema.sql`, ADRs em [../ADR/architecture/](../ADR/architecture/)

5. **Como estão os arquivos gerados (schema, API, reports)?**  
   → Leia: [04_SOURCES_GENERATED.md](04_SOURCES_GENERATED.md)  
   → Evidência: [../_generated/](../_generated/)

6. **Qual protocolo devo seguir para adicionar features/fixes?**  
   → Leia: [../_ai/INVARIANTS_AGENT_PROTOCOL.md](../_ai/INVARIANTS_AGENT_PROTOCOL.md)  
   → Referência: [../ADR/workflows/EXEC_TASK_ADR_MODELS_001.md](../ADR/workflows/EXEC_TASK_ADR_MODELS_001.md)
...
docs/
  ...
  02-modulos/      ← Modelos e invariantes por domínio
...
1. Se é sua **primeira vez**, leia [02_CONTEXT_MAP.md](02_CONTEXT_MAP.md) para entender fluxos
2. Se precisa **fazer algo imediatamente**, vá direto para [03_WORKFLOWS.md](03_WORKFLOWS.md)
3. Se tem dúvida sobre **o quê confiar**, consulte [01_AUTHORITY_SSOT.md](01_AUTHORITY_SSOT.md)
4. Se precisa **entender uma decisão**, busque no [../ADR/architecture/_INDEX_ADR.md](../ADR/architecture/_INDEX_ADR.md)
