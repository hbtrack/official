...
import { ExerciseCardEmpty, ExerciseCardSkeleton } from '@/components/training/exercises/ExerciseCard';
...
import { useDeleteExercise, useExerciseFilters } from '@/hooks/useExercises';
