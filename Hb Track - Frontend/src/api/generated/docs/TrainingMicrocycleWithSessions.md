...
**sessions** | [**Array&lt;TrainingSessionResponse&gt;**](TrainingSessionResponse.md) |  | [optional] [default to undefined]

## Example

```typescript
import { TrainingMicrocycleWithSessions } from './api';

const instance: TrainingMicrocycleWithSessions = {
    team_id,
    week_start,
    week_end,
    cycle_id,
