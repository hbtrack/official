...
**planning_deviation_flag** | **boolean** | Flag de desvio significativo | [optional] [default to false]

## Example

```typescript
import { TrainingSessionResponse } from './api';

const instance: TrainingSessionResponse = {
    organization_id,
    team_id,
    season_id,
    created_by_user_id,
