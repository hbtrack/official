#!/usr/bin/env python3
"""Execute AR_060 hb report (corrected validation command from Arquiteto)."""
import subprocess
import sys
import re
...
# Find AR file
ar_files = list((workspace_root / "docs" / "hbtrack" / "ars").rglob("AR_060_*.md"))
if not ar_files:
    print("ERROR: AR_060 file not found")
    sys.exit(1)
