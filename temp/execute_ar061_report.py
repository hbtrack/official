#!/usr/bin/env python
"""Executa hb report para AR_061 lendo o comando exato da AR."""
import subprocess
import sys
import re
...
ar_path = Path('docs/hbtrack/ars/features/AR_061_aplicar_migrations_0056-0061_e_regenerar_alembic_s.md')
...
result = subprocess.run(
    ['python', 'scripts/run/hb_cli.py', 'report', '061', validation_cmd],
    cwd=Path.cwd()
)
