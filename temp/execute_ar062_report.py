#!/usr/bin/env python
"""Executa hb report para AR_062 lendo o comando exato da AR."""
import subprocess
import sys
import re
...
ar_path = Path('docs/hbtrack/ars/features/AR_062_verificar_rbac_hardening_-_role_permissions_+_sche.md')
...
result = subprocess.run(
    ['python', 'scripts/run/hb_cli.py', 'report', '062', validation_cmd],
    cwd=Path.cwd()
)
