#!/usr/bin/env python
"""Executa hb report para AR_057 lendo o comando exato da AR."""
import subprocess
import sys
import re
...
ar_path = Path('docs/hbtrack/ars/features/AR_057_verificar_integridade_append-only_de_audit_logs_em.md')
...
result = subprocess.run(
    ['python', 'scripts/run/hb_cli.py', 'report', '057', validation_cmd],
    cwd=Path.cwd()
)
